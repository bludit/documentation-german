...
<!-- Position: 1 -->
---
Plugins befinden sich bei Bludit im Verzeichnis `bl-plugins`. and they have a pre-defined structure. Each plugin is an object in Bludit, with differents hooks (methods).
